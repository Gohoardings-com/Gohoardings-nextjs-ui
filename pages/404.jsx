...
const ErrorPage = () => {
  return (
    <div className={`${styles.media_branding_n} text-center`}>
      ...
      height={120}
      />
<h2 className="mt-2"> You've found a page that does'nt exist </h2>

      </div>
      <div className={`${styles.grid_containerN} container-xxl  container-xl text-center container-lg container-md my-5 p`}>
    ...
    <div class={styles.container} key={index}>
